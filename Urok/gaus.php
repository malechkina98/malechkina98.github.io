 ...
 <body>
  ...
  <ul class="topmenu">
    <li><a href="" class="down">Матрицы</a>
      <ul class="submenu">
      <li><a href="index.php">Обращение матриц</a></li></br>
  ...
  <div class="pyt"> Метод Гаусса</div>
    <div class="content">
      <div class="prav_nav">
  
  <ul class="nav">
      <li><a href="index.php">Обращение матриц</a></li>
    <li><a href="">Сложение матриц</a></li>
      <li><a href="gaus.html">Метод Гаусса</a></li>
  ...
  <p class="sravnenie">Введите индексы, которые расположены</br> рядом с неизвестными.</br>
  После того, как Вы ввели все значения, </br> нажмите кнопку "расчитать"</p>
  <!--
...
<div>
        <div>
    <input type="number" name="element1" class="elem1" id="vvod1" >
     <input type="number" name="element2" class="elem2" id="vvod1" >
      <input type="number" name="element3" class="elem3" id="vvod1" >=
      <input type="number" name="element10" class="elem10" id="vvod1"  >
  </div>
<div>
       <input type="number" name="element4" class="elem4" id="vvod1" >
        <input type="number" name="element5" class="elem5" id="vvod1" >
         <input type="number" name="element6" class="elem6" id="vvod1" >=
         <input type="number" name="element11" class="elem11" id="vvod1" >
</div>
<div>
          <input type="number" name="element7" class="elem7" id="vvod1" >
           <input type="number" name="element8" class="elem8" id="vvod1" >
            <input type="number" name="element9" class="elem9" id="vvod1" >=
            <input type="number" name="element12" class="elem12" id="vvod1" >
        </div>
        </div>

  <span class="input-group-btn3">
    <input type="submit" class="btn5" id="btn" value="Расчитать">
  ...
  <div id="result_form"></div> 
    ...
    <div class="footer">
        ...
        <ul class="list-unstyled">
                    <li><a href="index.html">Обращение матриц</a></li>
